...
import Automation        from './pages/automation/Automation'; // ← add
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route
            path="/ai"
            element={<AppWithLayout><AIIntelligence /></AppWithLayout>}
          />
          <Route
            path="/automation"
            element={<AppWithLayout><Automation /></AppWithLayout>} // ← add
          />
        </Routes>
      </AuthProvider>
    </BrowserRouter>
